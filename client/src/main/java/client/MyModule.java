...
public class MyModule implements Module {
    ...
    public void configure(Binder binder) {
        ...
        binder.bind(AddCollectionCtrl.class).in(Scopes.SINGLETON);
        ...
        binder.bind(AddNoteToCollectionCtrl.class).in(Scopes.SINGLETON);
        binder.bind(KeyboardShortcutsCtrl.class).in(Scopes.SINGLETON);
